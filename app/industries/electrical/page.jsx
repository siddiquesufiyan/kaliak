...
const customerNeeds = [
  {
    ...
    title: "Insulation",
    description:
      "Plastic and rubber components used where electrical assemblies require separation, insulation or non-conductive support.",
    icon: ShieldCheck,
  },
  {
    number: "02",
    title: "Protection",
    description:
      "Protective components used to cover, isolate and protect electrical parts during installation, operation and handling.",
    icon: ShieldCheck,
  },
  {
    number: "03",
    ...
    description:
      "Custom polymer components used for spacing, mounting, positioning and supporting electrical assemblies.",
    icon: Settings2,
  },
  {
    number: "04",
    ...
    description:
      "Small plastic and rubber parts required to complete electrical products, equipment and assemblies.",
    icon: PackageCheck,
  },
];
...
const customerTypes = [
  {
    title: "Electrical Equipment Manufacturers",
    description:
      "Manufacturers of electrical equipment can source application-specific plastic and rubber components required within their assemblies.",
    icon: Zap,
  },
  {
    title: "Electrical Panel & Assembly Companies",
    description:
      "Businesses involved in electrical panels, assemblies and equipment can procure polymer components according to their required specifications.",
    icon: Factory,
  },
  {
    title: "Electrical Component Businesses",
    description:
      "Companies manufacturing or assembling electrical components can outsource required plastic and rubber parts to a dedicated manufacturing partner.",
    icon: Settings2,
  },
  {
...
const process = [
  {
    ...
    description:
      "The electrical business shares its drawing, sample, dimensions or component requirement with us.",
    icon: FileCheck2,
  },
  {
    number: "02",
...
export default function ElectricalIndustryPage() {
  ...
  return (
    <main className={`${bg} ${text} font-body overflow-hidden`}>
      ...
      <section className="pt-6 sm:pt-6 lg:pt-10 pb-6 sm:pb-4 lg:pb-12">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            ...
            <span className={text}>Electrical</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <h1 className="font-heading font-semibold tracking-[-0.045em] leading-[0.98] text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] xl:text-[4.7rem]">
                Electrical companies need components.
              ...
              >
                Electrical equipment and assembly businesses require plastic
                and rubber components for insulation, protection, spacing,
                mounting and assembly. Kalika Engineering manufactures these
                components according to the actual requirements of electrical
                businesses.
              </p>
              ...
              >
                ...
                We manufacture the required component for your application.
              </p>
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-3 mt-8 sm:mt-9">
                ...
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[#ff6501]" />
                  <span className={`text-sm ${muted}`}>B2B Manufacturing</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative lg:mt-0">
              ...
              >
                <Image
                  src="/electrical-industry.png"
                  alt="Plastic and rubber components used by electrical industries"
                  fill
                  preload
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-[#ff6501]/10 flex items-center justify-center shrink-0">
                    <Zap size={20} className="text-[#ff6501]" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[0.85fr_1.15fr] gap-10 lg:gap-20 items-start">
            ...
            <div>
              ...
              <h2 className="font-heading font-semibold tracking-[-0.04em] leading-[1.05] text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem]">
                Your electrical product needs more than just electrical
                components.
              </h2>
            </div>
            ...
            <div className="lg:pt-1">
              ...
              >
                Behind every electrical product there are numerous supporting
                components. Plastic and rubber parts may be used for insulation,
                protection, spacing, mounting, covering or assembly.
              </p>
              ...
              <div
                className={`mt-8 sm:mt-10 border-l-2 border-[#ff6501] pl-5 sm:pl-6`}
              >
          ...
          <div className="mt-14 sm:mt-16 lg:mt-20">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
              {[
                ["Electrical Business", "Your product / application"],
      ...
      {/* =========================================================
          WHAT ELECTRICAL BUSINESSES SOURCE
      ========================================================= */}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="font-heading font-semibold tracking-[-0.04em] leading-[1.05] text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
              Components electrical businesses{" "}
              <span className="text-[#ff6501]">
                need from a manufacturing partner.
              </span>
            </h2>

            <p className={`mt-6 text-base sm:text-lg leading-7 sm:leading-8 ${muted}`}>
              We do not approach every electrical requirement as a standard
              product. The component is developed and manufactured around the
              requirement of the business and its application.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className={`mt-2.5 text-sm sm:text-base leading-7 ${muted}`}>
                      {item.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-10 lg:gap-20 items-start">
            <div>
              ...
              <p className={`mt-6 text-base sm:text-lg leading-7 sm:leading-8 ${muted}`}>
                ...
                components that electrical businesses need for their products
                and assemblies.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div>
              ...
              <h2 className="font-heading font-semibold tracking-[-0.04em] leading-[1.05] text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
                Already have a component requirement?
              </h2>

              <p className={`mt-6 text-base sm:text-lg leading-7 sm:leading-8 ${muted}`}>
                You do not need to explain everything from scratch. If your
                electrical business already has a drawing, sample or defined
              ...
              <p className={`mt-4 text-sm sm:text-base leading-7 ${muted}`}>
                ...
                possibilities based on your application and quantity.
              </p>
              ...
              <Link
                href="/contact"
                className="group inline-flex items-center justify-center gap-3 bg-[#ff6501] text-white px-6 py-3.5 sm:py-4 rounded-full font-semibold text-sm sm:text-base mt-9 hover:bg-[#e85b00] transition-all duration-300"
              >
            ...
            >
              <Image
                ...
                alt="Plastic and rubber component manufacturing for electrical industry"
                fill
                sizes="(max-width: 1024px) 100vw, 50vw"
                className="object-cover"
              />
      ...
      <section className={`${softBg} py-16 sm:py-20 lg:py-24`}>
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="font-heading font-semibold tracking-[-0.04em] leading-[1.05] text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
              From your electrical requirement to{" "}
              <span className="text-[#ff6501]">
          ...
          <div className="grid lg:grid-cols-[0.85fr_1.15fr] gap-10 lg:gap-20 items-start">
            <div>
              ...
              <p className={`mt-6 text-base sm:text-lg leading-7 sm:leading-8 ${muted}`}>
                ...
                application and quantity required by your business.
              </p>
            </div>
