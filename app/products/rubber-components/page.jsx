...
function RubberComp() {
  ...
  const relatedProducts = [
    ...
    },
    {
      title: "Gaskets",
      description:
        "Reliable sealing solutions designed for industrial, automotive and equipment applications.",
  ...
  const manufacturedProducts = [
    {
      ...
      description:
        "Precision rubber O-rings manufactured for sealing applications across industrial and automotive systems.",
      icon: CircleDot,
    },
    {
      title: "Rubber Bushes",
      description:
        "Durable rubber bushes designed for cushioning, vibration control and mechanical assemblies.",
      icon: Settings2,
    },
    {
      title: "Rubber Seals",
      description:
        "Application-specific rubber seals developed to help prevent leakage, dust and contamination.",
      icon: ShieldCheck,
    },
    {
      title: "Rubber Dust Caps",
      description:
        "Protective rubber dust caps designed to safeguard components from dust, moisture and external contaminants.",
      icon: Factory,
    },
    {
      title: "Rubber Washers",
      description:
        "Custom rubber washers manufactured for sealing, cushioning and spacing requirements.",
      icon: CircleDot,
    },
    {
      title: "Custom Rubber Parts",
      description:
        "Custom moulded rubber components manufactured according to drawings, dimensions and application requirements.",
      icon: Layers3,
    },
  ];
  ...
  const capabilities = [
    ...
    "EPDM Rubber Components",
    "Nitrile Rubber Components",
  ...
  const applications = [
    {
      number: "01",
      title: "Automotive",
      text: "Rubber components for automotive assemblies, protection, sealing and vibration control.",
    },
    {
      number: "02",
      title: "Electrical",
      text: "Rubber components for electrical equipment, insulation and protective applications.",
    },
    {
      number: "03",
      title: "Agriculture",
      text: "Durable rubber parts for tractors, agricultural machinery and farming equipment.",
    },
    {
      number: "04",
      title: "Industrial",
      text: "Custom rubber components for machinery, equipment and industrial applications.",
    },
  ];
  ...
  const reasons = [
    {
      ...
      text: "We understand the intended application and operating requirements before manufacturing.",
    },
    {
      number: "02",
      title: "Material Selection",
      text: "Rubber materials are considered according to application, flexibility, durability and performance requirements.",
    },
    {
      number: "03",
      title: "Precision Manufacturing",
      text: "Controlled moulding and production processes help maintain consistency across components.",
    },
    {
      number: "04",
      title: "Quality Inspection",
      text: "Finished rubber components are checked for dimensions, appearance and required specifications.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full overflow-hidden bg-black">
        ...
        >
          <Image
            src="/rubber-components-hero.png"
            alt="Rubber Components Manufacturing - Kalika Engineering"
            fill
            priority
            sizes="100vw"
            className="
          ...
          >
            <div className="max-w-2xl">
              ...
              >
                Rubber
                <span className="text-[#ff6501]"> Components</span>
              </h1>
              ...
              <p
                ...
                "
              >
                Precision-manufactured rubber components designed
                for sealing, cushioning, vibration control and
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <div>
              ...
              >
                Kalika Engineering manufactures precision rubber
                components for automotive, electrical, agriculture,
              ...
              >
                Components are developed according to application
                requirements, dimensions, material characteristics
                and operating conditions to deliver reliable
                performance across production requirements.
              </p>
              ...
              <div className="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {[
                  ...
                  "Application-Specific Rubber Materials",
            ...
            >
              ...
              <div className="space-y-5">
                {[
                  {
                    label: "Product Type",
                    value: "Custom Rubber Components",
                  },
                  {
                    label: "Manufacturing",
                    value: "Rubber Moulding",
                  },
                  {
                    label: "Applications",
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            >
              From sealing components to cushioning and
              application-specific rubber parts, we manufacture
              components according to drawings, dimensions and
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                >
                  Explore our plastic component manufacturing
                  capabilities for automotive, electrical and
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-20">
            ...
            <div>
              ...
              <p className="mt-5 max-w-xl text-sm leading-7 text-white/55 sm:text-base">
                Rubber material selection and manufacturing
                methods are considered according to the component
                application, required flexibility, durability,
                sealing requirements and operating conditions.
              </p>
