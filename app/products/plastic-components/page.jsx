  ...
  const relatedProducts = [
    {
      ...
      description:
        "Precision rubber components manufactured for sealing, cushioning and demanding industrial applications.",
    ...
    },
    {
      title: "Gaskets",
      description:
        "Reliable gasket solutions designed for sealing requirements across industrial and automotive applications.",
    ...
    },
    {
      ...
      description:
        "Custom rubber and plastic automobile components developed for automotive assemblies.",
  ...
  const manufacturedProducts = [
    {
      ...
      description:
        "Precision plastic components developed for automotive assemblies and applications.",
      icon: Factory,
    },
    {
      title: "Electrical Components",
      description:
        "Plastic parts designed for electrical equipment, assemblies and insulation requirements.",
      icon: ShieldCheck,
    },
    {
      title: "Injection Moulded Parts",
      description:
        "Application-specific plastic components manufactured according to drawings and dimensions.",
      icon: Settings2,
    },
    {
      title: "Plastic Covers & Housings",
      description:
        "Functional covers and housings designed for protection, assembly and durability.",
      icon: Layers3,
    },
    {
      title: "Plastic Bushes & Spacers",
      description:
        "Precision components used for spacing, positioning and mechanical assemblies.",
      icon: Settings2,
    },
    {
      title: "Clips & Retainers",
      description:
        "Custom plastic clips and retaining components for secure industrial assemblies.",
      icon: ShieldCheck,
    },
  ];
  ...
  const applications = [
    {
      number: "01",
      title: "Automotive",
      text: "Plastic components for automotive assemblies and systems.",
    },
    {
      number: "02",
      title: "Electrical",
      text: "Components for electrical equipment and assemblies.",
    },
    {
      number: "03",
      title: "Agriculture",
      text: "Durable parts for tractors, machinery and agricultural equipment.",
    },
    {
      number: "04",
      title: "Sanitaryware",
      text: "Precision components for sanitary and plumbing applications.",
    },
  ];
  ...
  const reasons = [
    {
      ...
      text: "We understand the intended application before manufacturing.",
    },
    {
      number: "02",
      title: "Material Selection",
      text: "Materials are considered according to performance and application needs.",
    },
    {
      number: "03",
      title: "Precision Manufacturing",
      text: "Controlled production focused on consistency and dimensional accuracy.",
    },
    {
      number: "04",
      title: "Quality Inspection",
      text: "Finished components are checked before dispatch.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full overflow-hidden bg-black">
        ...
        >
          <Image
            src="/plastic-components-hero.png"
            alt="Plastic Components Manufacturing - Kalika Engineering"
            fill
            priority
            sizes="100vw"
            className="
          ...
          >
            <div className="max-w-2xl">
              ...
              <p
                ...
                "
              >
                Precision-manufactured plastic components designed
                for consistent performance, dimensional accuracy
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <div>
              ...
              >
                Kalika Engineering manufactures precision plastic
                components for automotive, electrical, agriculture,
                sanitaryware and other industrial applications.
              </p>
              ...
              >
                ...
                and production needs, helping customers achieve
            ...
            >
              ...
              <div className="space-y-5">
                {[
                  {
                    label: "Product Type",
                    value: "Custom Plastic Components",
                  },
                  {
                    label: "Manufacturing",
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            >
              From simple moulded parts to application-specific
              components, we manufacture plastic products according
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-20">
            ...
            <div>
              ...
              <p className="mt-5 max-w-xl text-sm leading-7 text-white/55 sm:text-base">
                ...
                required performance and production requirements.
              </p>
...
<Faq/>
      <section className="w-full bg-black px-5 py-14 sm:px-8 sm:py-16 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-8 border border-white/10 bg-white/[0.03] p-6 sm:p-8 lg:flex-row lg:items-center lg:justify-between lg:p-10">
            <div className="max-w-2xl">
              <div className="mb-3 flex items-center gap-2">
                <span className="h-2 w-2 bg-[#ff6501]" />
