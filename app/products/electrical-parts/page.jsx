...
function ElectricalParts() {
  ...
  const relatedProducts = [
    {
      ...
      description:
        "Precision plastic components manufactured for electrical, automotive and industrial applications.",
    ...
    },
    {
      ...
      description:
        "Precision rubber components designed for insulation, sealing, protection and vibration control.",
    ...
    },
    {
      title: "Gaskets",
      description:
        "Reliable gasket solutions developed for sealing requirements across electrical and industrial applications.",
    ...
    },
    {
      ...
      description:
        "Precision rubber and plastic components designed for automotive assemblies and applications.",
  ...
  /* =====================================================
      ELECTRICAL PRODUCTS WE MANUFACTURE
  ====================================================== */
  ...
  const manufacturedProducts = [
    {
      ...
      description:
        "Precision plastic components developed for electrical equipment, assemblies and industrial applications.",
      icon: Zap,
    },
    {
      title: "Electrical Rubber Parts",
      description:
        "Durable rubber components designed for insulation, protection, cushioning and electrical applications.",
      icon: CircleDot,
    },
    {
      title: "Insulating Components",
      description:
        "Plastic and rubber components designed to provide electrical insulation, protection and reliable assembly.",
      icon: ShieldCheck,
    },
    {
      title: "Protective Covers & Caps",
      description:
        "Protective components manufactured to shield electrical parts from dust, moisture, impact and contaminants.",
      icon: Layers3,
    },
    {
      title: "Bushes & Washers",
      description:
        "Precision components used for insulation, spacing, cushioning and mechanical support in electrical assemblies.",
      icon: Settings2,
    },
    {
      title: "Custom Electrical Components",
      description:
        "Custom rubber and plastic electrical components manufactured according to drawings, dimensions and application requirements.",
      icon: Factory,
    },
  ];
  ...
  const applications = [
    {
      ...
      text: "Precision rubber and plastic components developed for electrical equipment, assemblies and industrial systems.",
    },
    {
      number: "02",
      title: "Switchgear & Controls",
      text: "Components for insulation, protection, sealing and functional requirements in switchgear and control assemblies.",
    },
    {
      number: "03",
      title: "Industrial Electrical Systems",
      text: "Durable components designed for demanding industrial electrical equipment and operating environments.",
    },
    {
      number: "04",
      title: "Wiring & Assemblies",
      text: "Protective, insulating and support components used across wiring systems and electrical assemblies.",
    },
  ];
  ...
  const reasons = [
    {
      number: "01",
      title: "Electrical Application Understanding",
      text: "Components are developed with consideration for their intended electrical application and operating conditions.",
    },
    {
      number: "02",
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full overflow-hidden bg-black">
        ...
        >
          <Image
            src="/electrical-parts-hero.png"
            alt="Electrical Parts Manufacturing - Kalika Engineering"
            fill
            priority
            sizes="100vw"
            className="
          ...
          >
            <div className="max-w-2xl">
              ...
              <p
                ...
                "
              >
                Precision-manufactured rubber and plastic electrical
                components designed for reliable insulation, protection,
                dimensional consistency and demanding electrical applications.
              </p>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                plastic components for electrical equipment, assemblies,
                industrial systems and supporting applications.
              </p>
              ...
              >
                ...
                requirements to support consistent quality and reliable
                performance.
              </p>
              ...
              <div className="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {[
                  "Custom Electrical Component Manufacturing",
            ...
            >
              ...
              <div className="space-y-5">
                {[
                  {
                    label: "Product Type",
                    value: "Custom Electrical Components",
                  },
                  {
                    label: "Materials",
                  ...
                  {
                    label: "Applications",
                    value: "Electrical & Industrial Systems",
                  },
                  {
                    label: "Customization",
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            >
              From insulating components and protective covers to bushes,
              washers and custom moulded parts, we manufacture electrical
              components according to drawings, dimensions and application
              requirements.
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                >
                  ...
                  manufacturing capabilities for electrical,
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-20">
            ...
            <div>
              ...
              <p className="mt-5 max-w-xl text-sm leading-7 text-white/55 sm:text-base">
                ...
                considered according to component requirements,
                application conditions, required performance and
                durability.
              </p>
